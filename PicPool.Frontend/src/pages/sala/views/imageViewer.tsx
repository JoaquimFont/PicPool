...
export const ImageViewer: React.FunctionComponent<ComponentProps> = React.memo((props) =>{
  ...
  return (
  <div className={getContainerClassName()} onMouseDown={() => props.onMouseDown?.(props.imagePk)}>
    <div className={"internal-container"}>
      <img className = {"image-preview"} src={props.source} />
    </div>
  </div>
  )
});